...
class MongoExtractorFactory:
    ...
    class _extractor:
        def __init__(
            ...
            self.cursor = database[collection_name].find(
                {}, {"_id": int(with_id)}, batch_size=batch_size
            )
    ...
    def __call__(
        ...
        return self._extractor(
            collection_name, wrapper_model, self.db, batch_size, with_id
        )
