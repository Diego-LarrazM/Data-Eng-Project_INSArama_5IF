...
from DockerETL_Images.Ingestion.IMDBCurler.scripts.utils.execution import SUCCESS, FAILURE
...
class TestMongoLoaderCSV(unittest.TestCase):
    ...
    def setUp(self, mock_mongo_client):
        ...
        self.mock_client.start_session.return_value.__enter__ = MagicMock(return_value=MagicMock())
        self.mock_client.start_session.return_value.__exit__ = MagicMock(return_value=None)
...
class TestMongoLoaderSingleMultiple(unittest.TestCase):
    ...
    def test_load_multiple_success(self):
        ...
        self.mock_collection.insert_many.assert_called_with(data, session=unittest.mock.ANY)
